...
var simReport = {
    ...
    sendDataToLTI: function() {
        ...
        //var totolPossiblePoints = self.calculateTotalPossiblePoints;
	...
	startActivity: function (activity) {
        ...
        reportData.activityData.push({ id: activity.id, title: activity.title, totalActivityScore: totalActivityScore});
    ...
    submitTaskScore: function (taskScore) {
        ...
        console.log('calculated total score', reportData);
